  ...
  const createHandler=()=>{
    ...
    return(
        ...
        <div className={styles.inputs}>
            <div>
                <label htmlFor="islandName">島名<span>【必須】</span></label>
                <input type="text" id='islandName' className={styles.inputA}/>
            </div>

            <div>
                <label htmlFor="detail">活動内容<span>【必須】</span></label>
            ...
            <div>
                ...
                <input type="file" id='thumbnail' className={styles.inputA} onChange={handleFileChange}/>
            </div>
            
            <div>
                <label htmlFor="email">ログインID（登録メールアドレス）</label>
                <input type="email" id='email' className={styles.inputA}/>
            </div>
